...
class FieldTest(TestCase):
    ...
    def test_show_help(self):
        res = render_form_field('Entry')
        self.assertIn('my_help_text', res)
        self.assertNotIn('<i>my_help_text</i>', res)
        res = render_template_with_form('{% bootstrap_field form.Entry show_help=0 %}')
    ...
    def test_required_field(self):
        if DBS3_SET_REQUIRED_SET_DISABLED:
            required_field = render_form_field('Entry')
    ...
    def test_empty_permitted(self):
        ...
        if DBS3_SET_REQUIRED_SET_DISABLED:
            required_css_class = 'bootstrap3-req'
            form = TestForm()
            res = render_form_field('Entry', {'form': form})
    ...
    def test_input_group(self):
        res = render_template_with_form('{% bootstrap_field form.Entry addon_before="$"  addon_after=".00" %}')
    ...
    def test_input_group_addon_button(self):
        res = render_template_with_form(
            '{% bootstrap_field form.Entry addon_before="$" addon_before_class="input-group-btn" addon_after=".00" addon_after_class="input-group-btn" %}')  # noqa
        self.assertIn('class="input-group"', res)
    ...
    def test_size(self):
        def _test_size(param, klass):
            res = render_template_with_form('{% bootstrap_field form.Entry size="' + param + '" %}')
    ...
    def test_label(self):
        res = render_template_with_form('{% bootstrap_label "foobar" label_for="Entry" %}')
        self.assertEqual('<label for="Entry">foobar</label>', res)
...
class ShowAddonsTest(TestCase):
    ...
    def test_show_addons_textinput(self):
        self.assertFieldHasAddons("Entry")
